                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p ><a href="manage-branch.php" class="text-muted">Total Branch</a></p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-primary"><?php echo $conn->query("SELECT * FROM dbranch") ->num_rows; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="ti-gift"></i></h3>
                                            <p ><a href="manage-goods.php" class="text-muted">Total Goods</a></p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-cyan"><?php echo $conn->query("SELECT * FROM goods") ->num_rows; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p ><a href="manage-staff.php" class="text-muted">Total staffs</a></p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-purple"><?php echo $conn->query("SELECT * FROM staffs where type != 1") ->num_rows; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <h3><i class="ti-truck"></i></h3>
                                            <p ><a href="manage-vehicle.php" class="text-muted">Total Vehicles</a></p>
                                        </div>
                                        <div class="ml-auto">
                                            <h2 class="counter text-success"><?php echo $conn->query("SELECT * FROM vehicles") ->num_rows; ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
