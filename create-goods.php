...
include 'config.php';
// isset($_SESSION['success'])? header("location:create-goods.php"):'';

   if (isset ($_POST['register'])){
       include 'manage-goods.php';
   }
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h2 class="text-themecolor">Create Goods</h2>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="create-goods.php" id="manage-goods" method="post">
                                ...
                                <table id="piscel_item" class="table display table-bordered table-striped no-wrap">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <?php if(!isset($id)): ?>
                                        <td><button class="btn btn-sm btn-danger" type="button" onclick="$(this).closest('tr').remove() && calc()">cancel</button></td>
                                        <?php endif; ?>
                                      </tr>
                                    </tbody>
                                        <?php if(!isset($id)): ?>
