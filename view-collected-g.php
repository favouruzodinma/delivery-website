...
?>
<div class="modal fade" id="exampleModalyz" tabindex="-1" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<dl>
									...
									<dt>Status:</dt>
									<dd><?php echo $row['goods_default'] ?></dd>
								</dl>	
							</div>
						</div>
					<dl>
						...
						<dd>
							<?php 
							switch ($goods_default) {
						
								
								default:
									echo "<span class='badge badge-pill badge-info'> Item Collected</span>";
    ...
    <div class="modal-content">
      ...
      <div class="form-group">
            ...
            <select class="form-control" id="exampleFormControlSelect1" name="type">
               <option></option>
               <option <?php echo $row['goods_default']?> value="goods_default"> Collected </option>
